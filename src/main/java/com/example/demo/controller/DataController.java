...
public class DataController {
    ...
    public ResponseEntity<String> productUpdate(@RequestBody ProductDTO product) {
    	boardService.productUpdate(product);
    	return ResponseEntity.ok("Product and Company updated successfully");
    }
}
